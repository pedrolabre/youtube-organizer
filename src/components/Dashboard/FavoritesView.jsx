...
import SortSelect from '../UI/SortSelect'; // Import
import useSort from '../../hooks/useSort'; // Import
...
const FavoritesView = () => {
  ...
  // 1. Filtra favoritos E busca
  const filteredVideos = videos.filter(v => 
    v.favorite && v.title.toLowerCase().includes(searchTerm.toLowerCase())
  );
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Meus Favoritos ❤️</h1>
        ...
        <div className="space-y-3">
          {sortedVideos.length === 0 ? (
            <div className="text-center py-12 bg-white dark:bg-gray-800 rounded-xl border-2 border-dashed border-gray-300 dark:border-gray-700">
              <p className="text-gray-500">Nenhum vídeo favorito encontrado.</p>
            </div>
          ) : (
